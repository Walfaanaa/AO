...
# 2️⃣ FILE PATHS
# ===============================
DATA_FILE = "AO_uqubii.xlsx"   # change if your file name is different
...
try:
    ...
    st.error("❌ members_data.xlsx not found. Upload it to your GitHub repo.")
    st.stop()
